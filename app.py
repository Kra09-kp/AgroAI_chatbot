...
def main():
    ...
    with st.sidebar:        
        ...
        with st.expander("Feedback"):
            ...
            st.write("[✉️ Send Feedback](mailto:kirtipogra@gmail.com)")
        ...
        st.write("Hello! I'm Kirti Pogra, a passionate and dedicated individual with a strong interest in artificial intelligence, machine learning, and data science. With a background in computer science, I'm constantly exploring new technologies and seeking innovative solutions to complex problems. I created the AgroAI Chatbot as a project to showcase my skills and contribute to the agricultural community.")
